export BasisSet, Basis, GeometricBasisSet, PrimitiveBasis, ContractedBasis,
       SimpleGaussianBasis, CustomBasis, GaussianBasis, ComplexGaussianBasis,
...
Base.@kwdef struct CustomBasis{F<:Function} <: Basis
  f::F
end
...
This is a basis set with exponents generated by `geometric(r₁, rₙ, n; nₘₐₓ=n, nₘᵢₙ=1)`. You can define the 20 real-range Gaussian basis functions used for the hydrogen atom in Appendix A.2 and Table VII of [E. Hiyama, M. Kamimura, Front. Phys. 13, 132106 (2018)](https://doi.org/10.1007/s11467-018-0828-5) like this:
```math
  r_1 = 0.1,
...
An s-wave basis function defined by `f(r)`. Rayleigh–Ritz overlap,
non-relativistic kinetic, rest-energy, and central-potential matrix elements
are evaluated by radial quadrature. The function must be real-valued,
square-integrable, differentiable by ForwardDiff.jl, and regular at the
origin.
""" CustomBasis
